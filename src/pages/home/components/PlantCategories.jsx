    ...
    <section className='category_section'>
      ...
      <div className='image_container'>
        <div className='large_image_wrapper'>
          <img src="images/home-images/category_plant1.jpg" alt="plant-category-image" />
        ...
        <div className='small_image_container'>
          <div className='small_image_wrapper'>
            <img src="images/home-images/category_plant2.jpg" alt="plant-category-image" />
            <Link to={"/shop"} className='link'>Succulents <sup>(3)</sup></Link>
          </div>
          <div className='small_image_wrapper'>
            <img src="images/home-images/category_plant3.jpg" alt="plant-category-image" />
            <Link to={"/shop"} className='link'>Potter Plants <sup>(4)</sup></Link>
          </div>
          <div className='small_image_wrapper'>
            <img src="images/home-images/category_plant4.jpg" alt="plant-category-image" />
            <Link to={"/shop"} className='link'>Terrariums <sup>(1)</sup></Link>
          </div>
          <div className='small_image_wrapper'>
            <img src="images/home-images/category_plant5.jpg" alt="plant-category-image" />
